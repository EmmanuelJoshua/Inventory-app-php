...
<?php $page = 'tank';include("includes/sideNavigation.php") ?>
<!DOCTYPE html>
<html>
	<head>
		...
		<div class="dashboard-wrapper pt-3">
			<div class="container">
				...
				<div class="row">
					<div class="container-fluid">
						<!-- DIV FOR TANK -->
						<div id="tank" class="animated fadeIn">
						...
						<div id="tankLedger" class="d-none animated fadeIn">
							<div class="top-controls">
								<div class="form-inline">
									<select class="custom-select form-control col-md-2 col-4 mb-2">
